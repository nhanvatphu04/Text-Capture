...
class ResourceLoader:
    ...
    def load_fonts_from_file(self) -> list:
        ...
        """
        font_files = [
            os.path.join(self.src_path, "resources", "fonts", "JetBrainsMono-Regular.ttf"),
            os.path.join(self.src_path, "resources", "fonts", "JetBrainsMono-Bold.ttf"),
            os.path.join(self.src_path, "resources", "fonts", "JetBrainsMono-Italic.ttf"),
            os.path.join(self.src_path, "resources", "fonts", "JetBrainsMono-Light.ttf"),
            os.path.join(self.src_path, "resources", "fonts", "JetBrainsMono-Medium.ttf")
        ]
